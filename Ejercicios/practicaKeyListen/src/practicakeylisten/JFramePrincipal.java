...
public class JFramePrincipal extends JFrame{
   ...
   private static final JPanel panelFlechas = new JPanel(new GridLayout(4, 1));
    ...
    private void initComponentes() {
        ...
        EscuchadorFlechas listenerFlechas = new EscuchadorFlechas();
        
        JButtonFlechas btnUp = new JButtonFlechas("UP", dimF, Color.yellow);
        ...
        JButtonFlechas btnDown = new JButtonFlechas("DOWN", dimF, Color.yellow);
        ...
        JButtonFlechas btnLeft = new JButtonFlechas("LEFT", dimF, Color.yellow);
        ...
        JButtonFlechas btnRight = new JButtonFlechas("RIGTH", dimF, Color.yellow);
